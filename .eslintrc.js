      ...
      'error',
      {
        zones: [
          ...
          // Resolvers must use services, not repositories
          {
            ...
            message:
              'Resolvers must use services layer, not repositories directly.',
          },
          ...
          // Services cannot import resolvers
          {
            ...
            message:
              'Services cannot depend on presentation layer (resolvers).',
          },
          // Domain cannot import from services
          {
            ...
            message:
              'Domain entities should not depend on application services.',
          },
        ],
      },
    ],
